...
[![Build status](https://github.com/elacosse/poetry-project-template/workflows/build/badge.svg?branch=master&event=push)](https://github.com/elacosse/poetry-project-template/actions?query=workflow%3Abuild)
[![Dependencies Status](https://img.shields.io/badge/dependencies-up%20to%20date-brightgreen.svg)](https://github.com/elacosse/poetry-project-template/pulls?utf8=%E2%9C%93&q=is%3Apr%20author%3Aapp%2Fdependabot)
...
[![Pre-commit](https://img.shields.io/badge/pre--commit-enabled-brightgreen?logo=pre-commit&logoColor=white)](https://github.com/elacosse/poetry-project-template/blob/master/.pre-commit-config.yaml)
[![Semantic Versions](https://img.shields.io/badge/%20%20%F0%9F%93%A6%F0%9F%9A%80-semantic--versions-e10079.svg)](https://github.com/elacosse/poetry-project-template/releases)
[![License](https://img.shields.io/github/license/elacosse/poetry-project-template)](https://github.com/elacosse/poetry-project-template/blob/master/LICENSE)
...
```bash
cookiecutter gh:elacosse/poetry-project-template --checkout v1.1.1
```
...
- [`Poetry`](https://python-poetry.org/) as a dependencies manager. See configuration in [`pyproject.toml`](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/pyproject.toml) and [`setup.cfg`](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/setup.cfg).
...
- Ready-to-use [`.editorconfig`](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/.editorconfig), [`.dockerignore`](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/.dockerignore), and [`.gitignore`](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/.gitignore). You don't have to worry about those things.

### Deployment features

- `GitHub` integration: issue and pr templates.
- `Github Actions` with predefined [build workflow](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/.github/workflows/build.yml) as the default CI/CD.
- Everything is already set up for security checks, codestyle checks, code formatting, testing, linting, docker builds, etc with [`Makefile`](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/Makefile#L89). More details in [makefile-usage](#makefile-usage).
- [Dockerfile](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/docker/Dockerfile) for your package.
...
- Automatic release notes with [`Release Drafter`](https://github.com/marketplace/actions/release-drafter). You may see the list of labels in [`release-drafter.yml`](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/.github/release-drafter.yml). Works perfectly with [Semantic Versions](https://semver.org/) specification.

### Open source community features

- Ready-to-use [Pull Requests templates](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/.github/PULL_REQUEST_TEMPLATE.md) and several [Issue templates](https://github.com/elacosse/poetry-project-template/tree/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/.github/ISSUE_TEMPLATE).
- Files such as: `LICENSE`, `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, and `SECURITY.md` are generated automatically.
- [`Stale bot`](https://github.com/apps/stale) that closes abandoned issues after a period of inactivity. (You will only [need to setup free plan](https://github.com/marketplace/stale)). Configuration is [here](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/.github/.stale.yml).
...
| `minimal_python_version` | `3.7`                       | Minimal Python version. One of `3.7`, `3.8` and `3.9`. It is used for builds, GitHub workflow and formatters (`ruff`and `pyupgrade`). |
...
| `line_length`            | 120                         | The max length per line (used for codestyle with `ruff`). NOTE: This value must be between 50 and 300. |
...
After you create a project, it will appear in your directory, and will display [a message about how to initialize the project](https://github.com/elacosse/poetry-project-template/tree/master/%7B%7B%20cookiecutter.project_name%20%7D%7D#very-first-steps).
...
[`Makefile`](https://github.com/elacosse/poetry-project-template/blob/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/Makefile) contains a lot of functions for faster development.
...
More information [about docker](https://github.com/elacosse/poetry-project-template/tree/master/%7B%7B%20cookiecutter.project_name%20%7D%7D/docker).
...
You can see the list of available releases on the [GitHub Releases](https://github.com/elacosse/poetry-project-template/releases) page.
...
This project is licensed under the terms of the `MIT` license. See [LICENSE](https://github.com/elacosse/poetry-project-template/blob/master/LICENSE) for more details.
